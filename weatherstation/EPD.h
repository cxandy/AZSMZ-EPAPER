...
/*
  ...
  static const unsigned char LUTDefault_part[31] = {
      ...
      0x18,0x18,0x08,0x18,0x18,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x13,0x14,0x44,0x12,0x00,0x00,0x00,0x00,0x00,0x00 
    };

  static const unsigned char LUTDefault_full[31] = {
    0x32, // command
    0x50, //C221 25C Full update waveform
    0xAA, 0x55, 0xAA, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
  };
#endif 
*/
...
class EPD_GDE : public DisplayDriver {

  public:
    EPD_GDE(EPD_TYPE epdType, uint8_t csPin, uint8_t rstPin, uint8_t dcPin, uint8_t busyPin);
  ...
  private:
    ...
    bool isFastRefreshEnabled = false;
